...
export default function Layout({ children }) {
    ...
    } else if (!cart || !cart?.entries.length > 0) {
        content = (
            <div className='bg-white'>
                <div className="mx-auto max-w-2xl py-3 sm:py-6 lg:max-w-7xl grid lg:grid-cols-2">
                    <div className="pt-8">
                        <p className="text-xl font-medium">No tienes productos en tu carrito de compra</p>
                        <p className="text-gray-400">Para proceder con el checkout necesitas almenos 1 producto en el carrito de compras.</p>
                    </div>
                </div>
            </div>)
    } else {
